...
#SBATCH --job-name=predict_2D_fsdp
#SBATCH --output=predict_2D_fsdp_%A_%a.out
#SBATCH --array=0
...
srun torchrun --nnodes $SLURM_NNODES --nproc_per_node 4 --max_restarts 1 --node_rank $SLURM_NODEID --rdzv_id 101 --rdzv_backend c10d --rdzv_endpoint "$MASTER_ADDR:$MASTER_PORT" ./predict_2D_fsdp.py
